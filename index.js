...
// قراءة التوكين من الملف المخفي
const token = process.env.TOKEN;

// استخدام التوكين في التطبيق
console.log(token); // زي العادة توكن بسيركيت يا بشر
...
const header = {
        'authorization': 'MTA4Nzc0NTY4MDA5NDc4OTY1NA.GUmOFD.E5K1YesZZM8DTxLcxKckW7j_RYCUPELW4Eb3v4'
        };
